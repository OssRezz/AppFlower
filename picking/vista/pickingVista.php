...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-9 col-xl-10 pb-2 vh-100 border-left">
                ...
                <div class="row mb-3 border-bottom border-top">
                    ...
                    <nav class="navbar navbar-light w-100">
                        <div class="navbar-brand">
                            <img src="img/dahlia.png" width="30" height="30" class="d-inline-block">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-sm-12 col-md-12">
                                            ...
                                            <select name="Labor" class="form-control">
                                                <option value="1" selected>Empaque</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-row">
